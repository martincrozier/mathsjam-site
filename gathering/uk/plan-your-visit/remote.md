...
As well as the talks, we have a range of [other activities]({{site.url}}/gathering/uk/whats-on/activities). You will be able to remotely join in with the Competition Competition and some of the [Saturday Night Tables]({{site.url}}/gathering/uk/whats-on/#tables) (where possible). The MathsJamJam will be live-streamed so you can watch, listen and sing along at home!
