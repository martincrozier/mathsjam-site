...
On all Gathering tickets, there are discounts of **10% for early-bird booking** (for the first 101 people to book using the code 'EARLYBIRD') and **10% for unwaged or low-income participants**, using the code 'TENOFF' (using the code 'EARLYOFF' will apply both discounts). Please contact [mailto:bookings@mathsjam.com](bookings@mathsjam.com) with any queries.
